...
<NavigationMenu.List className="center shadow-md m-0 flex list-none rounded-lg bg-white p-1">

        <NavigationMenu.Item>
         <NavigationMenu.Trigger className="text-purple-600 hover:bg-purple-300 focus:shadow-purple-700 group flex select-none items-center justify-between gap-1 rounded-md px-3 py-2 text-base font-medium leading-none outline-none focus:shadow-outline">
         ...
         <NavigationMenu.Content className="absolute top-0 left-0 w-full sm:w-auto">
            ...
            <ul className="one m-0 grid list-none gap-x-[10px] p-[22px] sm:w-[500px] sm:grid-cols-[0.75fr_1fr]">
              <li className="row-span-3 grid">
                 <NavigationMenu.Link className="text-purple-600 hover:bg-purple-300 focus:shadow-purple-700 block select-none rounded-md px-3 py-2 text-base font-medium leading-none no-underline outline-none focus:shadow-outline">
