...
const PrivacyPage = () => {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <h1 className="text-4xl font-bold my-8">Privacy Policy for Your Website Name</h1>
      <p className="text-xl mb-4">Last updated: Date</p>

      <h2 className="text-3xl font-semibold my-4">1. Introduction</h2>
      ...
      <p>We use cookies to store and collect information about your use of our site. Cookies are smalltext files stored on the device you are using to access this website. For more information on how we use cookies, please refer to our Cookie Policy.</p>
